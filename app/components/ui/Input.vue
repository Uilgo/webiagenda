...
import { ArrowPathIcon, ExclamationCircleIcon, EyeIcon, EyeSlashIcon } from '@heroicons/vue/24/outline'
...
const shouldShowPasswordToggle = computed(() => 
  isPasswordInput.value && props.showPasswordToggle && !props.disabled && !props.readonly
)
...
const paddingClasses = computed(() => {
  ...
  const hasRightIcon = !!props.iconRight || hasError.value || props.loading || shouldShowPasswordToggle.value
